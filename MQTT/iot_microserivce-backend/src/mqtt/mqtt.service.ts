...
export class MqttService {
  ...
  //here we creating the mqtt client proxy according to the documentation
  private client: ClientProxy;
  //here we are creating the variables about the rasberry pi Gpios pins
